...
| Content Package Pipeline | Text + Image | script, title/thumbnail package and export |
...
- Your API key is stored locally in browser `localStorage` and `.open-studio/settings.json` (git-ignored)
